...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------------|
     * |Fn|Tb|  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|    \|Del|
     * |---------------------------------------------------------------|
     * |Ctl|Cp|  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Enter   |PgU|
     * |---------------------------------------------------------------|
    ...
    [_QWERTY] = LAYOUT_vanilla( \
        ...
        LT(_FUNC,KC_TAB),   KC_Q,    KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,   KC_RBRC,KC_BSLS,KC_DEL, \
    ...
    [_MEDIA] = LAYOUT_vanilla( \
        KC_GRV, KC_F14, KC_F15, _______,_______, BL_DEC, BL_INC,KC_MPRV,KC_MPLY,KC_MNXT,KC_MUTE,KC_VOLD,KC_VOLU,_______,KC_EJCT, \
